...
export default class BaseBufferTri implements BaseBufferElement {
    private _konvaElement: Konva.RegularPolygon;
    ...
    constructor(center: Point, radius: number = 1,
        ...
        let konvaTri = new Konva.RegularPolygon({
        ...
        konvaGroup.add(konvaTri)

        this._konvaElement = konvaTri;
        this.config = config
    }
    ...
    get konvaElement(): Konva.RegularPolygon {
