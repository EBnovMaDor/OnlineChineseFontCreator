		...
		<div class="flex-container">
				...
				<div class="right">
					<el-row :gutter="0" style="margin-right:0; width:200px;">
						...
						<el-col :span="6"
							...
							<el-avatar :style="{ 'background-color': extractColorByName('Xu') }" :size="32">Xu</el-avatar>
						</el-col>
					</el-row>
				</div>
			</header>
			...
			<aside class="right-sidebar">
				...
				<div class="rsidebar-main">
					...
					<div v-if="pointPos"><br /> 点的坐标:<br /> x: {{ formatNumber(pointx1) }}, y:{{ formatNumber(pointy1) }}</div>
					<div v-if="linePos">
						<br /> 直线的两点坐标:<br /> (x1: {{ formatNumber(pointx1) }}, y1:{{ formatNumber(pointy1) }})
						<br /> (x2:{{ formatNumber(pointx2) }}, y2:{{ formatNumber(pointy2) }}) <br /><br />  直线的长度 : {{formatNumber(length1)}}
						<br /><br />  线的角度: {{ angle1 }}度
					</div>
					<div v-if="curvePos">
						<br /> 曲线的两点坐标: <br /> (x1: {{ formatNumber(pointx1) }}, y1:{{ formatNumber(pointy1)}})<br />
						(x2: {{ formatNumber(pointx2) }}, y2:{{ formatNumber(pointy2) }})<br /><br /> 控制线长度：{{formatNumber(length1) }} ;
