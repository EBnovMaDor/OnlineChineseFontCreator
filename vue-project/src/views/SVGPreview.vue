					...
					<div class="layer-panel">
						...
						<div class="layer-tree" style="flex:3;">
							<div style="padding:5px 5px 20px 5px; border-bottom: 2px solid #D9D9D9; text-align:right; ">
								<el-input type="textarea" resize="none" placeholder="请输入测试字符" v-model="word"
									style="margin-bottom:10px ;width: 240px;" :rows="6">
								</el-input>
							...
							<el-button v-for="button in buttons" :key="button" text bg class="wrap-botton"
								@click="setModelText(button)">
								{{ button }}
							</el-button>
