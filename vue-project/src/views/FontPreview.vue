			...
			<div class="main">
				...
				<div class="left-sidebar">
					...
					<div class="layer-panel">
						...
						<div class="task-tree">
							<el-select v-model="selectvalue" multiple clearable collapse-tags collapse-tags-tooltip
								filterable placeholder="选择预览字库" popper-class="custom-header" :max-collapse-tags="6"
								style="width: 240px;" @change="handleSelectChange">
				...
				<div class="right-main">
					<div class="font-preview">
						<el-collapse>
							<el-collapse-item v-for="font in selectfonts" :key="font.title" :title="font.title">
								<template #title>
								...
								<template #default>
									<div class="font-preview-block">
										<div v-for="fontcontent in font.content">
											<div v-if="font.title === '十二模板字' || font.title === 'GB2312-80'"
												style="height: 60px; margin-bottom: 0px;">
												<img :src="getImageUrl(font.title, fontcontent)" width="60"
													height="60" />
											</div>
											<div v-else
												style="background-color: #909399; height: 50px; width: 50px; margin-bottom: 10px;">
											</div>
